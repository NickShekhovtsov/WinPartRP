...
namespace WinFormPlayer
{
    ...
    { 
        ...
        public Commander cm = new Commander();
        
        public delegate void ArriveData();
        public event ArriveData DataCome;
               ...
               while (!stream.DataAvailable) ;
                ...
                else
                {
                    ...
                    else if (mask)
                    {
                        ...
                        try
                        {
                            cm = JsonSerializer.Deserialize<Commander>(text);
                        }
                        catch (Exception e)
                        {
                        ...
                        //byte[] responsee = CreateFrameFromString(outdata);
